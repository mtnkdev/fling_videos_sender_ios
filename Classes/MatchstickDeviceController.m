...
- (void)         deviceManager:(MSFKDeviceManager *)deviceManager
didReceiveStatusForApplication:(MSFKApplicationMetadata *)applicationMetadata {
    self.applicationMetadata = applicationMetadata;
}
...
#pragma mark - MSFKDeviceFilterListener
- (void)deviceDidComeOnline:(MSFKDevice *)device
            forDeviceFilter:(MSFKDeviceFilter *)deviceFilter
{

...
/**
 * A view to play media locally, when not connected to the Matchstick device.
 */
@interface LocalPlayerViewController : UIViewController<MatchstickControllerDelegate>

/** The media object being played on Matchstick device. Set this before presenting the view. */
